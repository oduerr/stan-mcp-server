...
Observations of a continuous predictor and a continuous response. The goal is to predict `response` for held-out test observations. Domain knowledge suggests the response follows an oscillatory pattern with a gradual overall trend. The training data contains some outliers.
