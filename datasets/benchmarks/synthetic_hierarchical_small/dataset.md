...
We measured a continuous outcome ("effect") for 200 units belonging to 20 groups (10 units per group). We suspect there is variation both within and between groups — units in the same group may share a common tendency.
...
There are 160 training observations (8 per group). A held-out test set of 40 observations (2 per group) is used for evaluation.
