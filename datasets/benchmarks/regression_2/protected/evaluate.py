#!/usr/bin/env python3
"""Evaluate model.stan on the Count Regression dataset.
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate model.stan on Count Regression dataset")
    ...
    stan_data = {
        ...
        "response_train": [int(r["response"]) for r in train_rows],
        "response_test": [int(r["response"]) for r in test_rows],
    }
